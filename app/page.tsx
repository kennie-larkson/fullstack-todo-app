...
export default function Home() {
  return (
    <div className="flex px-6  md:px-40 min-h-screen">
      <div className="flex flex-col w-full justify-center space-y-6 bg-white text-black text-sm md:text-xl font-normal md:font-semibold font-sans rounded-lg md:rounded-none ">
        <div className="flex items-end justify-center space-x-0 md:space-x-1 my-8 md:my-12 px-1">
